  ...
  return (
    <div>
      ...
      <div className="bg-stone-900 p-1 rounded-md shadow-[0px_5px_15px_rgba(0,0,0,1)]">
        <h1 className="p-2 font-bold text-[#9C667D] text-xl">Contacto</h1>
            ...
            <div className="mt-8 overflow-hidden">
              <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="p-6 my-8 bg-stone-800 rounded-lg">
                  <h1 className="text-4xl sm:text-5xl text-[#9C667D] font-extrabold tracking-tight">
                    Contáctame
                  </h1>
                  <p className="text-normal text-lg sm:text-2xl font-medium text-[#9C667D] mt-2">
                    Enviame un correo electronico
                  </p>

                  <div className="flex items-center mt-8 text-[#9C667D]">
                    <svg
                  ...
                  <div className="flex items-center mt-4 w-56 text-[#9C667D] shadow-inherit border border-transparent hover:border-[#9C667D] rounded-md hover:scale-105 transition-all duration-300 ease-in-out">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                      className="w-8 h-8"
                ...
                >
                  <div className="flex flex-col">
                    <input
                      ...
                      className="w-100 mt-2 py-3 px-3 rounded-lg placeholder:text-stone-900 bg-[#9C667D] border border-[#9C667D] text-stone-900 font-semibold focus:border-[#9C667D] focus:outline-none"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    className="bg-[#9C667D] text-stone-900 font-bold py-3 px-6 rounded-lg mt-3 hover:bg-[#7e5165] transition ease-in-out duration-300 lg:w-32"
                  >
                    Enviar
                  </button>
                </form>
